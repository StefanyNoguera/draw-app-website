...
function Toolbox(colourPalette) {
  ...
  this.applySelectedColour = function(){
    if (this.colourPalette && this.colourPalette.selectedColour) {
      fill(this.colourPalette.selectedColour);
      stroke(this.colourPalette.selectedColour);
    }
  }
}
